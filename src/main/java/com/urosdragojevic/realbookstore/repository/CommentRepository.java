...
public class CommentRepository {
    ...
    public void create(Comment comment) {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            LOG.warn("Neuspesno ubacivanje komentara " + comment.getComment());
            e.printStackTrace();
        }
        AuditLogger.getAuditLogger(CommentRepository.class).audit("Dodavanje komentara: " + comment.getComment());
    }
    ...
    public List<Comment> getAll(int bookId) {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            LOG.warn("Neuspesno dohvatanje komentara knjige: " + bookId);
            e.printStackTrace();
        }
        return commentList;
    }
