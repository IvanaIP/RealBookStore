...
public class BookRepository {
    ...
    public List<Book> getAll() {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            LOG.error("Neuspesno dohvatanje svih knjiga iz baze");
            e.printStackTrace();
        }
    ...
    public List<Book> search(String searchTerm) throws SQLException {
        ...
        AuditLogger.getAuditLogger(BookRepository.class).audit("Unos: " + searchTerm);
        return bookList;
    }
    ...
    public long create(NewBook book, List<Genre> genresToInsert) {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            LOG.error("Neuspesno umetanje knjige u bazu");
            e.printStackTrace();
        }
